...
public class gameClient extends Thread implements ActionListener {
	private String me,other;	//p1,p2구분
	...
	private int player;
	private JLabel p1Ready;		//p1의 준비버튼
	private JLabel p2Ready;		//p2의 준비버튼
	private JLabel win;			//승자
	private JLabel lifeP1;		//p1의 목숨
	private JLabel lifeP2;		//p2의 목숨
